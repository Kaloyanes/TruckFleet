...
const MarkdownInput = React.forwardRef<
  React.ElementRef<typeof MarkdownTextInput>,
  InputProps
>(
  (
    {
    ...
    // Combine style props to ensure proper style application
    const combinedStyle = StyleSheet.flatten([style, inputStyle]);
