...
<template>
  <div class="flex w-full max-w-full my-2 mr-2 gap-4 flex-grow-0">
    <LazyOrderAddDialog />
    ...
    <div class="flex flex-col flex-[0.4] gap-4">
      <div
        class="flex-[1] bg-[rgb(17,17,17)] rounded-xl p-6 relative overflow-hidden"
      >
        <OrderSelected />
        <circle
          class="absolute w-[400px] h-[400px] blur-[125px] top-[40%] left-[30%] z-0 rounded-full bg-primary/35"
        ></circle>
      </div>
      <div class="flex-[0.5] bg-[rgb(17,17,17)] rounded-xl"></div>
      <div class="flex-[0.4] flex gap-4">
        <div class="bg-[rgb(17,17,17)] rounded-xl flex-[0.7]"></div>
        <div class="bg-[rgb(17,17,17)] rounded-xl flex-[0.3]"></div>
      </div>
    </div>
  </div>
</template>
