...
<template>
  <div class="flex w-full max-w-full my-2 mr-2 gap-4">
    <div class="flex flex-col flex-[0.2] flex-grow-0 gap-4">
      <div
        class="flex-[1] bg-[rgb(17,17,17)] rounded-xl w-full relative overflow-scroll flex flex-col h-full px-4"
      >
        <div
          class="self-end p-3 mb-1 mx-2 sticky top-1 z-[50] flex items-center w-full gap-2"
        >
          <LazyTrucksSearch />
