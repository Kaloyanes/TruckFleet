	...
	"fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-[cubic-bezier(0.68, -0.55, 0.27, 1.55)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300 ",
	{
		variants: {
			side: {
				...
				left: "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-lg motion-preset-blur-lg",
				right:
					"inset-y-0 right-0 h-full w-3/4 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right motion-preset-blur-lg sm:max-w-lg",
			},
		},
		defaultVariants: {
			side: "right",
